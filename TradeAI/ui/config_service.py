...
FIELDS: tuple[ConfigField, ...] = (
    ...
    ConfigField("BREAK_EVEN_TRIGGER_PIPS", "Break-even trigger (pips)", "float", "Execution", minimum=0, maximum=100000),
    ConfigField("USE_TRAILING_STOP", "Trailing stop", "bool", "Execution"),
    ConfigField("TRAILING_TRIGGER_PIPS", "Trailing trigger (pips)", "float", "Execution", minimum=0, maximum=100000),
